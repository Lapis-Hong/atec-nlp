...
Main results:
    * positive sample percentage: 21.73%
    * length from 5 to 97, 
...
def positive_sample_percentage():
    tot, pos = 0, 0
...
def pair_length_diff_distribution():
    tot, pos = 0, 0
    tot_diff = []
    pos_diff = []
    neg_diff = []
...
if __name__ == '__main__':
    # positive_sample_percentage()
    # sentence_length_distribution()
    pair_length_diff_distribution()
